...
public:
    ...
    bool applyGlobal(unsigned int shaderId, unsigned long frameNumber, Mat4 *projection, Mat4 *view, Vector4f *ambientColor, Vector3f *
                     viewPosition, unsigned int renderMode) const override;
